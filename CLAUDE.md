...
src/
  ...
  engine/
    ...
    touch.ts             Controles de toque estilo Terraria mobile (D-pad em cruz de movimento/pulo/agachar, joystick flutuante de mira, tap exato/lupa de precisão, botões discretos de menu e fullscreen); inerte em dispositivos sem tela de toque
